  ...
  return (
    <Container pos="relative" maxW="100%" maxH="100%" p="0">
      <Head>
        ...
        <meta property="og:image" content="/_next/image?url=%2Fwedding%2F26-min.jpg&w=828&q=75" />
        ...
        <meta property="twitter:image" content="/_next/image?url=%2Fwedding%2F26-min.jpg&w=828&q=75" />
      </Head>
